...
import { signatureDishes, WHATSAPP_NUMBER } from '../data/menuData';
...
export default function SignatureDishes() {
  ...
  const waUrl = (dish) => {
    const msg = encodeURIComponent(`Hi! I'd like to order ${dish.name} (₹${dish.price}) from Malligai Restaurant 🍛`);
              ...
              <div className="dish-card-img-wrapper">
                ...
                <div className="dish-card-overlay">
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); window.open(waUrl(dish), '_blank'); }}
                  >
                    🛒 Add to Order
                  </button>
                </div>
              ...
              <div className="dish-card-info">
                ...
                <div className="dish-card-meta">
                  ...
                  <span className="dish-card-rating">
                    <span>⭐</span> {dish.rating} · {dish.orders}
                  </span>
                </div>
              </div>
            </motion.div>
      ...
      <AnimatePresence>
        {selectedDish && (
          ...
          >
            ...
            >
              <button className="dish-modal-close" onClick={() => setSelectedDish(null)}>✕</button>
              ...
              <div className="dish-modal-body">
                ...
                <div className="dish-modal-footer">
                  ...
                  <a href={waUrl(selectedDish)} target="_blank" rel="noopener noreferrer" className="dish-modal-wa-btn">
